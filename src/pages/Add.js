    ...
    <div className="dash-content">
      <div className='container'>
        <div className='btn-group btn-group-lg d-flex gap-2' role="group" aria-label="....">
          <button className='btn btn-dark' value={''} onClick={goBack}>Back</button>
          ...
          <button type="button" className="btn btn-dark w-100 active">Add</button>
        ...
        <div className='d-flex' style={{backgroundColor: "rgb(255,192,203)", border: "1px solid black"}}>
